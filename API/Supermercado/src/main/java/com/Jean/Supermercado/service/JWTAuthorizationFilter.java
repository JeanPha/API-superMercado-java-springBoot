...
import static com.Jean.Supermercado.service.JWTConfig.SECRET_KEY;
...
public class JWTAuthorizationFilter extends OncePerRequestFilter {
    ...
    private final String PREFIX_TOKEN = "SimpleToken "; // Token simple
    private final String SECRET = SECRET_KEY; // Asegúrate de usar un enfoque más seguro para las claves
    ...
    private boolean validateSimpleToken(String token) {
        String validToken = SECRET_KEY; // Aquí deberías validar el token según sea necesario
